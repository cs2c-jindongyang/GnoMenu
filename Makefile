...
install:
	...
	#-cp -r src/share/  mate-panel dbus-1
	-cp -r src/share/mate-panel $(DESTDIR)$(PREFIX)/share
	-cp -r src/share/dbus-1 $(DESTDIR)$(PREFIX)/share
...
uninstall:
	...
	rm -rf $(PREFIX)/share/mate-panel/applets/org.mate.panel.GnoMenuApplet.mate-panel-applet
	rm -rf $(PREFIX)/share/dbus-1/services/org.mate.panel.applet.GnoMenuAppletFactory.service
