...
DefaultSettings = { "Tab_Efect":1 , "Bind_Key":"Super_L" , "Sound_Theme":"None" , "Show_Thumb":0 ,"Disable_PS":0, "Show_Tips":0 , "Prog_List":3 , "System_Icons":0 , "Distributor_Logo":0, "Menu_Name":"XP" , "IconSize":28 , "ListSize":10 , "SuperL":0 , "Icon_Name":"Newstyles" , "Button_Name":"XP" , "Shownetandemail":1 , "GtkColors":0 , "TabHover":0 , "Search":"mate-search-tool" , "Network_Config":"nm-connection-editor" , "Control_Panel":"mate-control-center" , "Package_Manager":"gksu synaptic" , "Help":"yelp" , "Power":"mate-session-save --shutdown-dialog" , "Lock":"gnome-screensaver-command --lock" , "Suspend":'python -u ' + ProgramDirectory + "session-manager.py suspend" , "Shutdown":'python -u ' + ProgramDirectory + "session-manager.py shutdown" , "Hibernate":'python -u ' + ProgramDirectory + "session-manager.py hibernate" , "Run":"mate-panel --run-dialog" , "Logout":"mate-session-save --logout-dialog" , "LogoutNow":"gnome-session-save --logout" , "Restart":'python -u ' + ProgramDirectory + "session-manager.py reboot" , "User":"mate-about-me" , "AdminRun":"gksu", "MenuEditor":"alacarte", "Default_Program":"gnome-default-applications-properties", "Printer":"system-config-printer"}
